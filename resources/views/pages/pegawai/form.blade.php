                                    ...
                                    <div class="col-12">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    @foreach ($pegawai->berkas as $item)
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ $item->jenis }}</td>
                                                                            <td><a href="{{ asset('storage/' . $item->nama_berkas) }}" target="_blank" class="btn btn-primary"><i class="ft-download"></i></a></td>
                                                                        </tr>
                                                                    @endforeach
                                                                </tbody>
                                                            </table>
                                        ...
                                        <div class="card">
                                            <div class="card-content collapse show">
                                                <div class="card-body">
                                                    <div class="form-body">
                                                        <h4 class="form-section"><i class="ft-file"></i>Tambah Berkas</h4>
                                                        <div id="perulangan-form">
                                                            <div class="row" id="berkas-reapeater">
                                                                ...
                                                                <div class="form-group col-md-2 col-sm-12 text-center mt-2">
...
@section('script')
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#add').click(function(){
                i++;
                $('#perulangan-form').append('<div class="row" id="berkas_repeater'+i+'">\
                                    <div class="form-group col-md-4 col-sm-12 ">\
                                        <label for="file">File</label>\
            ...
            $(document).on('click', '.btn_remove',function(){
                ...
                $('#berkas_repeater' + button_id + '').remove();
            })
        })
    </script>
@endsection