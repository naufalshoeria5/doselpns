        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse show" id="navbar-mobile">
                <ul class="nav navbar-nav mr-auto float-left">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="position-relative has-icon-left">
                                                ...
                                                <div class="form-control-position pl-1"><i class="ft-smartphone"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li class="nav-item d-none d-md-block"><a class="dropdown-toggle nav-link" id="apps-navbar-links"
                            href="#" data-toggle="dropdown">
                            Markas Besar Tni Angkatan Darat Direktorat Ajudan Jendral</a></li>
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <span class="avatar avatar-online">
                                <img src="{{ asset('app-assets/images/portrait/small/avatar-1.png') }}" alt="avatar">
                            </span>
                        </a>
