                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="text" name="nip" class="form-control round" id="nip"
                                                    placeholder="Masukan NIP(Nomor Induk Pegawai)" required>
                                                @error('nip')
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="text" name="name" class="form-control round" id="name"
                                    ...
                                    <p class="card-subtitle text-muted text-right font-small-3 mx-2 my-1">
                                        <span>Sudah Memiliki Akun ?
                                            <a href="{{ route('login') }}" class="card-link">Login Sekarang</a>
                                        </span>
                                    </p>
                                </div>
                            </div>
